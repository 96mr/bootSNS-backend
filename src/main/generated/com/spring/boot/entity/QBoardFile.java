...
public class QBoardFile extends EntityPathBase<BoardFile> {
    ...
    private static final long serialVersionUID = -1411926849L;
    ...
    public QBoardFile(Class<? extends BoardFile> type, PathMetadata metadata, PathInits inits) {
        ...
        this.fno = inits.isInitialized("fno") ? new QFileInfo(forProperty("fno")) : null;
    }
    ...
    public QFileInfo fno() {
        if (fno == null) {
            fno = new QFileInfo(forProperty("fno"));
        }
        return fno;
    }
